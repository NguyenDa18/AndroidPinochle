 ...
 * added a number chooser for the number of points required to win
 */
...
//		}
	...
	private final String launchGame(GameConfig config) {
		...
		pointsToWin=config.getNumPointsToWin();
	...
	protected void initStarterGui() {
		...
		String [] pickerValues={"100","150","200","250","Endless"};
		NumberPicker picker = (NumberPicker)findViewById(R.id.numPointsToWinNumberPicker);
		picker.setWrapSelectorWheel(false);
		picker.setMinValue(2);
		picker.setMaxValue(6);
		picker.setDisplayedValues(pickerValues);
        picker.setValue(config.getNumPointsToWin());
	...
	public GameConfig scrapeData() {
        ...
        NumberPicker pointsToWinPicker =(NumberPicker)findViewById(R.id.numPointsToWinNumberPicker);
        int pointsToWin= pointsToWinPicker.getValue();
        result.setNumPointsToWin(pointsToWin);
	...
	protected int getNumPointsToWin(){
		if (pointsToWin==6) return Integer.MAX_VALUE;
		return pointsToWin*50;
	}
}
